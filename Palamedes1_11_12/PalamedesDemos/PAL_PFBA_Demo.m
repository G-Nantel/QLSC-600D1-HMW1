...
%
%Since the introduction of the PAL_PFHB routines in version 1.10.0, the
%PAL_PFBA routines have become obsolete. In order to perform Bayesian fit 
%of one or multiple PFs, use PAL_PFHB_firModel instead.
%
